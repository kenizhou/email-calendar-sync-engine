...
/// Migration v14: `person.display_name` goes nullable.
///
...
INSERT INTO person_v14 (id, ordinal, display_name, payload)
SELECT id, ordinal, display_name, payload FROM person;

DROP TABLE person;

ALTER TABLE person_v14 RENAME TO person;
