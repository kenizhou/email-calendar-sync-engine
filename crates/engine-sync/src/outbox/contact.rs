...
/// verb names. The execution half the inline driver runs; outcome classification and recording stay
/// with the caller.
...
/// without a call. The execution half the inline driver runs; outcome classification and recording
