...
pub use outbox::{
    ...
    drain_contact_ops, drain_mail_ops, edit_mail, patch_calendar_event, patch_contact,
    put_calendar_document, report_message, rsvp_calendar_event, submit_mail, submit_mail_source,
};
